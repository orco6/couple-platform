...
export const he = {
  ...
  tasks: {
    ...
    removePhotoBody: 'התמונה לא תישמר עם המשימה.',
    removePhotoBodySaved: 'התמונה תימחק מהמשימה כשתשמרו.',
    removePhotoConfirm: 'הסרה',
    openPhoto: 'הצגת התמונה במסך מלא',
    photoAlt: (title: string) => `התמונה של המשימה: ${title}`,
    photoTooBig: 'התמונה גדולה מדי. אפשר לנסות תמונה אחרת.',
    photoNotImage: 'זה לא נראה כמו תמונה.',
    photoFailed: 'המשימה נשמרה, אבל התמונה לא עלתה. אפשר לנסות שוב.',
  ...
  taskRating: {
    ...
    changeRating: 'שינוי הדירוג',
    notRatedYet: 'עוד לא דירגת',
  ...
  week: {
    ...
    overviewTitle: 'סיכום',
    pageIntro: 'כל שבוע, מראשון עד שבת: מה עשינו ביחד.',
    lastWeek: 'שבוע שעבר',
    tasksDone: 'משימות בוצעו',
    loading: 'טוענים את הסיכום',
    byPerson: 'לפי מי',
    ratingAverage: 'דירוג ממוצע של המשימות',
    noTasksThisWeek: 'לא היו משימות בשבוע הזה.',
    notYet: 'עוד אין',
    ...
    noTasks: 'בלי משימות',
    tasksLine: (done: number, total: number) => `${done} מתוך ${total} משימות`,
    executionShort: 'דירוג משימות',
    respectShort: 'כבוד',
    togetherShort: 'ימים ביחד',
    openWeek: 'לכל הפרטים',
  ...
  settings: {
    ...
    photoRemoveTitle: 'להסיר את התמונה שלך?',
    photoRemoveBody: 'במקומה תופיע הנקודה בצבע שלך.',
